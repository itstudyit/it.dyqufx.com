...
下载链接：https://it.dyqufx.com/posts?id=1120

<img src="https://ziyuanyun.oss-cn-guangzhou.aliyuncs.com/yun/20240515153618/664465f2f3a43.jpg" width="500" alt="">

  ┣━mksz309 &#8211; React源码深度解析 高级前端工程师必备技能

 ┣━第3章 React中的更新

 ┣━03-01 react-dom-render (2).mp4

 ┣━03-03 react-fiber (2).mp4

 ┣━03-06 different-expirtation-time (2).mp4

 ┣━03-02 react-fiber-root (2).mp4

 ┣━03-05 react-expiration-time (2).mp4

 ┣━03-04 react-update-and-updateQueue (2).mp4
 ...
 ┣━06-05 初次渲染中如何进行DOM节点属性初始化操作 (2).mp4

 ┣━06-06 更新DOM时进行的diff判断 (2).mp4

 ┣━06-02 重设childExpirationTime (2).mp4

 ┣━06-03 completWork具体做了什么 (2).mp4

 ┣━06-07 completeWork阶段对于HostText的更新.mp4

 ┣━06-04 初次渲染中completeWork对于DOM节点的创建和appendAllChild算法 (2).mp4

 ┣━06-01 completeUnitOfWork的整体流程和意义 (2).mp4
 ...
 ┣━09-2 优先级和任务挂起的含义（2） (2).mp4

 ┣━09-1 优先级和任务挂起的含义（1） (2).mp4

 ┣━09-5 Suspense组件同步渲染模式补充 (2).mp4

 ┣━09-4 Suspense组件同步模式下的更新 (2).mp4

 ┣━09-6 Suspense组件异步模式下的更新 (2).mp4

 ┣━09-3 两个expirationTime的不同作用 (2).mp4
