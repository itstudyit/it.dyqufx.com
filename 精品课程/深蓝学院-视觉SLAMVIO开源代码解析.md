...
下载链接：https://it.bcwex.shop/posts?id=1624

<img src="https://ziyuanyun.oss-cn-guangzhou.aliyuncs.com/yun/20240515183251/66448f535aa86.jpg" width="500" alt="">

  ┣━slxy0013-深蓝学院-视觉SLAM VIO开源代码解析

 视觉SLAM是当下SLAM的重要分支，由于其需要扎实的数学、三维几何以及C++编程等基础知识，入门者自学进度较慢，并且学习路径并不清晰。鉴于此，学院将视觉SLAM基础与VIO进阶两门课程整合成一个视觉SLAM的学习包，希望通过整个学习包，让同学们打下扎实的基础。

 深蓝学院-视觉SLAM VIO开源代码解析



 ┣━32-1basalt视觉前端 (1).pdf
 ...
 ┣━36. IMU因子的代码实现、视觉因子、FET[16].mp4

 ┣━35批量优化&amp;滑窗优化、IMU因子、IMU偏置因子[16].mp4
 ...
 ┣━39-3 MSCKF前端开源代码讲解[16].mp4

 ┣━39-4MSCKF_vio_no_ros.tar

 ┣━39-2 MSCKF前端流程[16].mp4
