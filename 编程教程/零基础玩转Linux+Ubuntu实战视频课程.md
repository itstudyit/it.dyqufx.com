...
下载链接：https://it.bcwex.shop/posts?id=2658

<img src="https://ziyuanyun.oss-cn-guangzhou.aliyuncs.com/yun/20240515184205/6644917dd84ba.jpg" width="500" alt="">

  【资源介绍】:

 适合人群：

 嵌入式爱好者、初学者、学生，Linux初学者，对Linux感兴趣的年满10周岁的公民，初级工程师

 你将会学到：

 让Linux初学者快速学习使用Linux、熟悉Ubuntu环境，熟练学习各种格式的软件的安装、卸载；学习Linux的常用命令、在Linux下创建一个软件项目的方法；熟悉Linux下Samba、SSH、NFS等常用网络服务的配置和使用。
