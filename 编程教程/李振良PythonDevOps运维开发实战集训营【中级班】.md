...
下载链接：https://it.bcwex.shop/posts?id=5082

<img src="https://ziyuanyun.oss-cn-guangzhou.aliyuncs.com/yun/20241201155437/674c163d9e5be.jpg" width="500" alt="">
 ...
 | ├──01-Django介绍，开发环境准备_ev.mp4 15.03M

 | ├──02-Pycharm，创建第一个项目，Django工作流程_ev.mp4 80.92M

 | ├──03-URL路由系统：配置、URL正则表达式匹配_ev.mp4 115.99M

 | ├──04-视图：HttpRequest详解1_ev.mp4 116.50M

 | ├──05-视图：HttpRequest详解2，HttpResponse详解_ev.mp4 141.64M

 | └──06-模板：变量、标签、过滤器、继承、导入等_ev.mp4 226.90M
 ...
 | ├──01-Layui介绍，基本使用，后台布局，栅格系统_ev.mp4 127.02M

 | ├──02-卡片面板，按钮，表单，上传文件_ev.mp4 285.61M

 | └──03-数据表格，弹出框_ev.mp4 304.04M
