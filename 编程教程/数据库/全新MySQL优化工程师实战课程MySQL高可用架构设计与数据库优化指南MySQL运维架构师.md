# 全新MySQL优化工程师实战课程 MySQL高可用架构设计与数据库优化指南 MySQL运维架构师
...
下载链接：https://it.bcwex.shop/posts?id=3495

<img src="https://ziyuanyun.oss-cn-guangzhou.aliyuncs.com/yun/20240515185208/664493d8ca860.jpg" width="500" alt="">
 ...
 (3)\第2章 什么影响了MySQL性能；目录中文件数:27个

 ├─2-01 影响性能的几个方面.wmv

 ├─2-02 CPU资源和可用内存大小.wmv
 ...
 ├─2-06 使用网络存储SAN和NAS.wmv

 ├─2-07 总结：服务器硬件对性能的影响.wmv

 ├─2-08 操作系统对性能的影响-MySQL适合的操作系统.wmv
 ...
 (12)\数据库源代码\sysbench-0.5；目录中文件数:12个
